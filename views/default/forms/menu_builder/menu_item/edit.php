...
$label_info_text = elgg_echo('menu_builder:add:form:languagekey:info');
$label_info_text .= !empty($menu_item['languagekey']) ?
    elgg_echo('menu_builder:add:form:languagekey:info:more', array(
        $menu_name,
        $menu_item['languagekey']
    )) : "";
$label_title = elgg_format_element('label', [], elgg_echo('menu_builder:add:form:languagekey'));
$label_title .= elgg_view('output/pm_hint', [
...
$form_body .= elgg_view('input/text', [
    'name' => 'languagekey',
    'value' => elgg_extract('languagekey', $menu_item),
]);
